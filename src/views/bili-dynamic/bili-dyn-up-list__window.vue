...
<div class="biliDynUpListWindow h-28 flex justify-start items-center overflow-hidden bg-white rounded-md relative">
  ...
  <div class="flex justify-center items-center absolute right-0 top-50% w-8 h-8 rounded-full">
    <div class="bg-white rounded-full w-6 h-6 mr-2 flex justify-center items-center"><svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 12 12"><path d="M4.27145 1.521445C4.076185 1.71671 4.076185 2.03329 4.27145 2.228555L7.9545 5.9116C8.0033 5.96045 8.0033 6.03955 7.9545 6.0884L4.27145 9.77145C4.076185 9.9667 4.076185 10.2833 4.27145 10.47855C4.46671 10.6738 4.783295 10.6738 4.978555 10.47855L8.6616 6.7955C9.10095 6.35615 9.10095 5.64385 8.6616 5.2045L4.978555 1.521445C4.783295 1.326185 4.46671 1.326185 4.27145 1.521445z" fill="currentColor"></path></svg></div>
  </div>
</div>
</template>
